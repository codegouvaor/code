...
type NotificationPreference struct {
	...
	PushEnabled                 bool   `gorm:"column:push_enabled;not null;default:true" json:"pushEnabled"`
	NewEpisodes                 bool   `gorm:"column:new_episodes;not null;default:true" json:"newEpisodes"`
	News                        bool   `gorm:"column:news;not null;default:true" json:"news"`
	Reminders                   bool   `gorm:"column:reminders;not null;default:true" json:"reminders"`
}
